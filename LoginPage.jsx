...
export default function LoginPage({ onLoginSuccess }) {
  ...
  const demoAccounts = [
    ...
    },
    {
      ...
      location: 'Himalayan Tours & Treks',
      name: 'Himalayan Tours & Treks',
      email: 'contact@himalayantours.in',
      role: 'PARTNER',
      badge: 'Verified Seller',
      gradient: 'linear-gradient(135deg, rgba(224,242,254,0.98), rgba(255,255,255,0.99))',
      ...
      >
        <div className="rounded-3xl p-6 sm:p-9 space-y-6 relative overflow-hidden"
          ...
          <div className="pt-2 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-500 gap-2 relative z-10">
            <div className="flex items-center justify-center space-x-3 mt-4 text-[11px] text-gray-500">
              <span>New to S.A.F.A.R.?</span>
              <Link to="/register" className="font-extrabold hover:underline text-blue-700">
                Tourist Register
              </Link>
              <span>•</span>
              ...
              <span>•</span>
              <Link to="/partner-register" className="font-extrabold hover:underline text-emerald-700">
