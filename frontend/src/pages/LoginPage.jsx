...
export default function LoginPage({ onLoginSuccess }) {
  ...
  const demoPersonas = [
    ...
    {
      id: 'partner_himalayan',
      label: '🏪 Tour Operator (Himalayan Tours & Treks)',
      email: 'contact@himalayantours.in',
      password: 'admin123',
      role: 'PARTNER',
      location: 'Himalayan Tours & Treks • Manali / Ayodhya',
      tag: '⭐ Verified Seller',
      desc: 'Private tourism agency offering verified pilgrim & adventure packages.'
    },
    {
      id: 'rajesh_guide',
      ...
      <div className="w-full max-w-xl relative z-10">
        ...
        >
          ...
          <div className="text-center text-xs text-slate-500 pb-1">
            <span>Are you a tourism operator or travel agency? </span>
            <Link to="/partner-register" className="text-emerald-700 font-extrabold hover:underline">
              Become a Tour Partner / Seller
            </Link>
          </div>
