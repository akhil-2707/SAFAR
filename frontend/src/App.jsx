          ...
          <AnimatePresence mode="wait">
            ...
            >
              <Routes location={location}>
                ...
                {/* S.A.F.A.R. Verified Package Marketplace (Private Agency & Authority Approved) */}
                <Route
                  path="/packages"
                  element={
                    <RequireAuth currentUser={currentUser}>
                ...
                />
                <Route path="/marketplace" element={<Navigate to="/packages" replace />} />
                ...
                />
                <Route path="/partner/register" element={<Navigate to="/partner-register" replace />} />

                <Route
                  path="/authority-packages"
                  element={
                    <AuthorityRouteGuard currentUser={currentUser}>
                      <PackageVerification />
                    </AuthorityRouteGuard>
                ...
                />
                <Route path="/authority/packages" element={<Navigate to="/authority-packages" replace />} />
